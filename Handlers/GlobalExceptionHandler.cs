...
{
    // IExceptionHandler (The Modern Way - .NET 8+)
    public class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> _logger, IProblemDetailsService problemDetailsService) : IExceptionHandler
    {
